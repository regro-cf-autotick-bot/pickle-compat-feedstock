...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pickle-compat-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12990&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pickle-compat-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pickle-compat` can be installed with:

```
conda install pickle-compat
```

It is possible to list all of the versions of `pickle-compat` available on your platform with:
